...
<div class="row" style=" width:90%; margin:auto">
  <?php
    ...
    $sql="SELECT users.userNo, users.username, users.email, users.pass, users.repass, products.productNo, products.productName, products.productDescription, products.productPrice, products.unregprodPicture FROM users JOIN products  ON users.userNo=products.userNo ORDER BY RAND()  LIMIT 6";
    ...
    <img src="<?php echo $rows['unregprodPicture'];?>"width="150" height="220" class="prodimg" alt=""><br>
